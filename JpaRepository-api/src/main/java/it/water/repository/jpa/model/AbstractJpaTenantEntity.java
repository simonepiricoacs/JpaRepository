 ...
 * Base class for non-expandable JPA entities that belong to a single company (tenant).
 * Carries the opaque, nullable {@code companyId} column mandated by {@link TenantResource}
 ...
 */
@MappedSuperclass
public abstract class AbstractJpaTenantEntity extends AbstractJpaEntity implements TenantResource {
